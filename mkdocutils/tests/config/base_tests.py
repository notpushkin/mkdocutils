...
from mkdocutils import exceptions
from mkdocutils.config import base, defaults
from mkdocutils.config.config_options import BaseConfigOption
...
class ConfigBaseTests(unittest.TestCase):
    ...
    def test_load_from_file(self):
        ...
        Allows users to specify a config other than the default `mkdocutils.yml`.
        """

        temp_dir = TemporaryDirectory()
        config_file = open(os.path.join(temp_dir.name, 'mkdocutils.yml'), 'w')
    ...
    def test_load_from_open_file(self):
        ...
        config_fname = os.path.join(temp_path, 'mkdocutils.yml')
    ...
    def test_load_from_file_with_relative_paths(self):
        ...
        config_fname = os.path.join(config_dir.name, 'mkdocutils.yml')
