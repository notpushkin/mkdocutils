...
from mkdocutils import config, plugins
from mkdocutils.commands import build
from mkdocutils.exceptions import BuildError, PluginError
from mkdocutils.tests.base import load_config
...
class TestPluginClass(unittest.TestCase):
    ...
    def test_valid_plugin_options(self):
        ...
        errors, warnings = plugin.load_config(
            options, config_file_path=cfg_fname,
        )
...
MockEntryPoint.configure_mock(
    **{'name': 'sample', 'load.return_value': DummyPlugin}
)
